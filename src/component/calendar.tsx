        ...
        <article className="courses">
          ...
          <div className="week-days">
            <div className="dayOne">
              <div className="item-3 highlights">
                <b>Estructuras de datos avanzado:</b>Compresiones, Generadores,
                itertools, Pilas, Colas, Listas, Árboles, etc
              </div>
              <div className="item-3 highlights">
          ...
          <div className="week-days">
            <div className="dayOne">
              ...
              <div className="item-2">
                <b>Programación Funcional: </b>Lambdas, Func. de Orden Superior,
                etc
              </div>
            </div>
            <div className="dayOne">
              <div className="item-2 highlights">
                <b>POO: </b>Clases, Herencia, Encapsulamiento, Polimorfismo, etc
              </div>
              <div className="item-2 highlights">
              ...
              <div className="item-2">
                <b>Buenas prácticas de programación: </b>Principios SOLID / KISS
                / DRY, Antipatrones
              </div>
            </div>
          </div>
